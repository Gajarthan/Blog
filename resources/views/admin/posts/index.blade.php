                ...
                <div class="pt-2">
                    <article class="sm:grid grid-cols-12 bg-white shadow-sm  relative  sm:p-4 rounded-lg justify-items-stretch hover:shadow-md ">
                        ...
                        <div class="sm:pt-0 sm:pl-5 col-start-2 col-span-8">
                            ...
                            <a class="border border-gray-300 opacity-75 hover:opacity-100 hover:border-gray-900 text-blue-900 hover:text-gray-900 rounded-full px-2 py-1 text-sm	">@if($post->categories != null){{ $post->categories->name }} @else Uncategorized @endif</a>
