...
<!--Header-->
<div class="w-full m-0 p-0 bg-cover bg-bottom" style="background-image:url('{{ asset('storage/image/bg.jpg') }}'); height: 60vh; max-height:460px;   background-position: center; background-size:cover;">
    <div class="container max-w-4xl mx-auto pt-16 md:pt-32 text-center break-normal ">
        <!--Title-->
        <div class="flex justify-center align-middle	">
            <img class="h-24" src="{{ asset('storage/image/logo.png') }}" height="10px">
            <div>
                <p class="text-white font-extrabold text-3xl md:text-5xl align-middle uppercase" style="line-height: 4rem !important;">
                    BOHAR WIND
                    <p class="text-xl md:text-2xl text-gray-400 uppercase">&#60;Welcome to our Blog/> </p>
                </p>
            </div>
        </div>
    </div>
            ...
            <a href="post.html" class="flex flex-wrap no-underline hover:no-underline">
                ...
                <div class="w-full md:w-1/3 flex flex-col flex-grow flex-shrink">
                    <div class="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow-lg">
                        ...
                        <div class="w-full font-bold text-xl text-gray-900 px-6">{{$posts->title}}</div>
