...
<!--Header-->
<div class="w-full m-0 p-0 bg-cover bg-bottom" style="background-image:url('{{ asset('storage/image/cover.jpg') }}'); height: 60vh; max-height:460px;   background-position: center; background-size:cover;">
        ...
        <div class="flex h-full bg-white rounded overflow-hidden shadow-lg">
            <a href="post.html" class="flex flex-wrap no-underline hover:no-underline">
                <div class="w-full md:w-2/3 rounded-t">	
                    <img src="{{ asset('storage/image/banner.jpg') }}" class="h-full w-full shadow">
                </div>
